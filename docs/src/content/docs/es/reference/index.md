...
- [Broker](/gokeel/es/reference/broker/) — el contrato de consumidor independiente del motor: `Consume`, las opciones de consumidor para ordenación, reintentos y broadcast, dead letters con `FindExhausted` y `Resubmit`, y los constructores de los motores en memoria y SQL.
